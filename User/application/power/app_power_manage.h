...
#define POWER_INPUT_ADC_4V            584       /*ADC value corresponding to 4V voltage*/
#define POWER_INPUT_ADC_4_2V          614       /*ADC value corresponding to 4.2V voltage*/
#define POWER_INPUT_ADC_4_5V          658       /*ADC value corresponding to 4.5V voltage*/
#define POWER_INPUT_ADC_5_5V          804       /*ADC value corresponding to 5.5V voltage*/
#define POWER_INPUT_ADC_6V            877       /*ADC value corresponding to 6V voltage*/
#define POWER_INPUT_ADC_6_5V          950       /*ADC value corresponding to 6.5V voltage*/
#define POWER_INPUT_ADC_18V           2632      /*ADC value corresponding to 18V voltage*/
#define POWER_INPUT_ADC_18_5V         2705      /*ADC value corresponding to 18.5V voltage*/
#define POWER_INPUT_ADC_26V           3801      /*ADC value corresponding to 26V voltage*/
#define POWER_INPUT_ADC_26_5V         3875      /*ADC value corresponding to 26.5V voltage*/
#define POWER_INPUT_ADC_27V           3948      /*ADC value corresponding to 27V voltage*/
