...
void CI2CComm_BacklightSetDuty(Elementype cmd_data, uint8_t index)
{
    ...
    if (CRCERR_MODE == struDim_CrcCount.enumCrcMode)            /*CRCERR_MODE PWM value is 15%*/
    {
...
{
    if (0x02 & cmd_data.data[0])
    {
        #if (SLEEP_MODULE == 1)
        /*Sleep_If_Module_Standby();*/   /*invalid, to be defined*/
        #endif
        /*Delay_Ms(50);*/                /*Cannot be executed in interrupt*/
