...
const eep_group1_ID_t eep_group1_ID_default = {  
        ...
        .data.HW_Version = {0x00,0x01},             /*hardware version*/
        .data.Firmware_Version = {0x22,0x00},       /*firmware version*/
        #if (TOUCH_MODULE == 1)
        .data.Touch_Controller_ID = 0,              
        #else
        .data.Touch_Controller_ID = 0xFF,           /*touch id for IPC*/
        #endif
        
        .data.Display_ID = 0x06,                    /*display id*/
        ...
        .data.Software_Part = {0x38,0x34,0x37,0x33,0x38,0x39,0x38,0x39},   /*software partnumber*/
        .data.Hardware_Part = {0x38,0x34,0x37,0x33,0x38,0x39,0x38,0x36},   /*hardware partnumber*/
