...
#define LCD_TD7800_MODULE    1  /*source ic OTP: 1 NOT OTP : 0*/
/**********************************************************************************************
* Local types
**********************************************************************************************/
...
void Lcd_If_Step1_Init(void)
{
    ...
    //Lcd_If_Set_Rl_Level(true); //Disabled accouding to new HSIS
    Delay_Ms(5);
    ...
    #if (1 == LCD_BRIDGE_MODULE)
	LCD_Bridge_Init(0,3);       //about 1.5ms
...
void Lcd_If_Read_Test(void)
{
    ...
    Lcd_If_SPI_Bridge_Read(read_comd,read_data,256);
#endif 
}
#endif /*LCD_READ_TEST*/
